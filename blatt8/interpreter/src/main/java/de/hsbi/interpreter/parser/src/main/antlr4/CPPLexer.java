...
public class CPPLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"CLASS", "PUBLIC", "VIRTUAL", "IF", "ELSE", "WHILE", "RETURN", "BOOL", 
			"INT", "CHAR", "STRING", "VOID", "BOOL_LITERAL", "PLUS", "MINUS", "MULT", 
			"DIV", "MOD", "ASSIGN", "EQ", "NEQ", "LT", "LEQ", "GT", "GEQ", "AND", 
			"OR", "NOT", "AMPERSAND", "DOT", "LPAREN", "RPAREN", "LBRACE", "RBRACE", 
			"SEMICOLON", "COMMA", "COLON", "INT_LITERAL", "CHAR_LITERAL", "STRING_LITERAL", 
			"ESC_SEQ", "IDENTIFIER", "LINE_COMMENT", "BLOCK_COMMENT", "PREPROCESSOR", 
			"WS"
		};
	}
